...
TaskKey[Unit]("ciStepsStatusReportSpec") := {
  ...
  (ci / stepsStatusReport).toTask("").value shouldBe s"""<table><tr><td colspan=5 width=8000><b><code>Compile / compile</code></b></td></tr><tr><td title="failed" width=40>:red_square:</td><td colspan=2><code>root / Compile / compile</code></td></tr><tr><td></td><td width=40>:x:</td><td>(<code>update</code>) sbt.librarymanagement.ResolveException: Error downloading org.scala-lang:scala-library:2.12.100<br />  Not found<br />  Not found<br />  not found: $ivyDir/local/org.scala-lang/scala-library/2.12.100/ivys/ivy.xml<br />  not found: https://repo1.maven.org/maven2/org/scala-lang/scala-library/2.12.100/scala-library-2.12.100.pom</td></tr><tr><td colspan=5 width=8000><b><code>Compile / compile</code></b></td></tr><tr><td title="failed" width=40>:red_square:</td><td colspan=2><code>root / Compile / compile</code></td></tr><tr><td></td><td width=40>:x:</td><td>(<code>update</code>) sbt.librarymanagement.ResolveException: Error downloading org.scala-lang:scala-library:2.12.100<br />  Not found<br />  Not found<br />  not found: $ivyDir/local/org.scala-lang/scala-library/2.12.100/ivys/ivy.xml<br />  not found: https://repo1.maven.org/maven2/org/scala-lang/scala-library/2.12.100/scala-library-2.12.100.pom</td></tr><tr><td colspan=5 width=8000><b><code>publish</code></b></td></tr><tr><td title="not completed" width=40>:white_large_square:</td><td colspan=2><code>root / publish</code></td></tr></table>"""
}
